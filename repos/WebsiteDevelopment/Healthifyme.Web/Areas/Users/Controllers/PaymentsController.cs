...
namespace Healthifyme.Web.Areas.Users.Controllers
{
    ...
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,PaymentType,PaymentAmount")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,PaymentType,PaymentAmount")] Payment payment)
        {
