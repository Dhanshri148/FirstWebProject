...
namespace HMS.Web.Areas.Foods.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderName,OrderStatus,OrderDate,Quantity,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderName,OrderStatus,OrderDate,Quantity,CustomerId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
